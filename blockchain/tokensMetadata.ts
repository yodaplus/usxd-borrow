...
const tokens = [
  ...
  },
  {
    ...
    color: '#234c81',
    background:
      'linear-gradient(180deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0.05) 100%),linear-gradient(213deg,#ffffff 3.42%,#7881ad 97.28%)',
    bannerIcon: staticFilesRuntimeUrl('/static/img/banner_icons/xdc.svg'),
    tags: [],
  },
  {
    symbol: 'BAT',
